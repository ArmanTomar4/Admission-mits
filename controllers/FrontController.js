  ...
  static sendEmail = async (name, email, token) => {
    ...
    let info = await transporter.sendMail({
      ...
      html:
        "<p>Hii " +
        name +
        ',Please click here to <a href="https://admission-mits.onrender.com/reset-password?token=' +
        token +
  ...
  static sendVerifyEmail = async (name, email, user_id) => {
    ...
    let info = await transporter.sendMail({
      ...
      html:
        "<p>Hii " +
        name +
        ',Please click here to <a href="https://admission-mits.onrender.com/verify?id=' +
        user_id +
